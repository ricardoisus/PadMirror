...
if xcrun swift -e 'import XCTest' >/dev/null 2>&1; then
    ...
    xcrun swiftc Sources/PadMirror/Models/MirrorDevice.swift Tests/PadMirrorTests/SelectionCases.swift scripts/testing/main.swift -o .build/checks/selection-tests
