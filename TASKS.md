...
- [x] CoreMediaIO, discovery external/muxed/USB, PreviewLayer direto e NSWindow real.
...
PreviewLayer primeiro. isPreviewing e inputPriority indisponíveis no macOS; sessionRunning não prova frames. Nenhuma engine AirPlay incluída. Áudio off. Métricas reais de latência/rotação ainda pendentes. Repositório privado durante desenvolvimento, conforme template; publicação open source ainda pendente.
